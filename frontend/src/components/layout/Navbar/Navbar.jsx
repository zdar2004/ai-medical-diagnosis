...
const PAGE_INFO = {
  ...
  "/patients/profile": {
    ...
    breadcrumb: ["Home", "Patients", "Patient Profile"],
  },
  "/diagnosis": {
    title: "Diagnosis",
    breadcrumb: ["Home", "Diagnosis"],
  },
  "/diagnosis/result": {
    title: "Diagnosis Result",
    breadcrumb: ["Home", "Diagnosis", "Diagnosis Result"],
  },
  "/reports": {
    title: "Report Analysis",
    breadcrumb: ["Home", "Report Analysis"],
  },
  "/risk": {
  ...
  "/assistant": {
    ...
    breadcrumb: ["Home", "Clinical Assistant"],
  },
};
        ...
        <div className={styles.profile}>
          <span className={styles.avatar}>
            ...
            >
              ...
              <path
                d="M5 19.5c1.4-3.2 4.2-4.8 7-4.8s5.6 1.6 7 4.8"
                strokeLinecap="round"
              />
            </svg>
          </span>
